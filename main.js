(() => {
  ...
  (() => {
    ...
    var e = document.querySelector('[name="avatar-info"]'),
      ...
      l = document.querySelector(".profile__subtitle");
    e.addEventListener("submit", function (e) {
    ...
    var i = document.querySelector(".popup_avatar"),
    ...
    document
      ...
      .addEventListener("click", function () {
        console.log(r), (t.value = r), f(i);
      }),
      document
        .querySelector(".profile__edit-button")
        .addEventListener("click", function () {
          (c.value = a.textContent), (u.value = l.textContent), f(s);
        }),
      document
